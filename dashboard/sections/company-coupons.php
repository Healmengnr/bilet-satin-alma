...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h6 class="mb-0">Toplam <?php echo count($coupons); ?> firma kuponu</h6>
    <button class="btn btn-success btn-sm" onclick="showModal('company-coupon-new')">
...
<?php if (empty($coupons)): ?>
    <div class="text-center text-muted py-4">
        ...
        <p class="mt-2">Henüz firma kuponu bulunmuyor.</p>
    </div>
<?php else: ?>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-primary" onclick="showModal('company-coupon-edit', '<?php echo $coupon['id']; ?>')">
                            <i class="bi bi-pencil"></i>
                        </button>
                        <button class="btn btn-sm btn-outline-danger" onclick="deleteItem('company-coupon', '<?php echo $coupon['id']; ?>')">
